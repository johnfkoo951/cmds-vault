...
- **Active since**: 2026
- **Areas of interest**: 
  - (e.g., AI safety, knowledge management, cognitive science)
  - (add more as you go)

### How I Use This Vault

Briefly describe your workflow. Examples:

- I capture daily fragments in `00. Inbox/01. Daily Notes/`
- I distill weekly into `30. Permanent Notes/` after running `/merge` and `/develop`
- I share polished outputs through Gobi Brain Updates
